...
package com.hendricks.musicstoreweb.app.conf;
...
@EnableJpaRepositories(basePackages = "com.hendricks.musicstoreweb.repository")
public class ConnectionConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory
        (DataSource dataSource, JpaVendorAdapter jpaVendorAdapter){
                ...
                lefb.setPackagesToScan("com.hendricks.musicstoreweb.domain");
                return lefb;
    }
